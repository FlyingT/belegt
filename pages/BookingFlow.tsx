...
import { ArrowLeft, Calendar as CalendarIcon, Clock, User, Mail, AlertCircle } from 'lucide-react';
...
export const BookingFlow: React.FC = () => {
  ...
  useEffect(() => {
    if (assetId) {
      api.getAssetById(assetId).then((data) => {
        if (!data) {
          navigate('/');
          return;
        }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">Sie erhalten eine Bestätigung per E-Mail.</p>
              </div>
            </div>
          </div>
